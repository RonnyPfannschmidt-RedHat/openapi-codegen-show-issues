...
from example.api_response import ApiResponse, T as ApiResponseT
import example.models
from example import rest
from example.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(example.models, klass)
