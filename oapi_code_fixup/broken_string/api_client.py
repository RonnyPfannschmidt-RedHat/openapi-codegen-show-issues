...
from oapi_code_fixup.broken_string.api_response import ApiResponse, T as ApiResponseT
import oapi_code_fixup.broken_string.models
from oapi_code_fixup.broken_string import rest
from oapi_code_fixup.broken_string.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(oapi_codegen.broken_string.models, klass)
