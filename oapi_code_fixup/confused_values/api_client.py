...
from oapi_code_fixup.confused_values.api_response import ApiResponse, T as ApiResponseT
import oapi_code_fixup.confused_values.models
from oapi_code_fixup.confused_values import rest
from oapi_code_fixup.confused_values.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(oapi_codegen.confused_values.models, klass)
