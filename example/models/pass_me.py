...
class PassMe(BaseModel):
    ...
    PassMe
    """ # noqa: E501
    mangled_string: PassMeMangledString
    confused_values: PassMeConfusedValues
    nice_values: PassMeNiceValues
    __properties: ClassVar[List[str]] = ["mangled_string", "confused_values", "nice_values"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mangled_string": PassMeMangledString.from_dict(obj["mangled_string"]) if obj.get("mangled_string") is not None else None,
